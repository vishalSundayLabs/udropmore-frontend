    ...
    <>
      <div className="footer">
        <div className="footer_wrapper">
          ...
          <div className="toggleShow mb-4">
            <h4 className="mb-3.5" style={{ textAlign: "center" }}>Subscribe to our newsletter</h4>{" "}
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="flex items-center"> <span className="mr-3"><BiPhoneCall /></span> +91 9876543210</p>
          <p className="flex items-center"> <span className="mr-3"><FaEnvelope /></span> abc@gmail.com</p>

          <div className="social_container mt-12">
            <h4 className="text-center mb-5 -ml-2">Follow us on:</h4>
