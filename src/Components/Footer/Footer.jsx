...
const Footer = () => {
    return (
        <div className="footer_container">
            ...
            <p className="text-xs text-end hide" style={{color: "#825BFF"}}>© 2022-2023 UDropmore All Rights Reserved.</p>
            <p className="text-xs text-center toggleShow" style={{color: "#825BFF"}}>© 2022-2023 UDropmore All Rights Reserved.</p>
        </div>
    );
};
