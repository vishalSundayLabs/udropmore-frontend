...
const Product = () => {
  ...
  return (
    <>
     ...
     <div className="timerfit ">
        <img
          src="/img/Time Remaining.svg"
          width={"90%"}
      ...
      <div className="main">
          ...
          <img
            src={
              window?.innerWidth > 800
                ? "/img/WhatsApp Image 2023-06-02 at 12.16 1.png"
                : "/img/WhatsApp Image 2023-06-02 at 12.16 1.png"
            }
          />{" "}
        </div>
        <div className="price-and-time">
          <div className="timerfit ">
            <h1 className="time-remaining">TIME REMAINING</h1>
            <Timer
              interval={
                1998800
                // new Date(auction.endTime).getTime() -
          ...
          <div className="price">
            <div className="price-box">
              <p>Market Price</p>
              <p>₹ 45000 {product.marketPrice}</p>
            </div>

            <div className="price-box">
              <p>Drop Starts</p>
              <p>₹ 1000 {auction.dropStartPrice}</p>
            </div>
            <div className="price-box">
              <p>Entry Fee</p>
              <p>₹ 2000 {auction.entryFees}</p>
            </div>
          </div>
        </div>
      </div>
<div className="play-station-section">
<div className="play-station">
        <h1>One Plu s Nord Lite</h1>
        <div className="properties">
          <div className="properties-element">
            <span>
              <svg
