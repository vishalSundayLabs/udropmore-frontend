          ...
          <div className="flex justify-center text-3xl my-32 md:mb-32">
            ...
            >
              ...
              <div
                ...
                style={{color: "black"}}
              >
                <div className="flex play-station"><h1>One plus nord</h1></div>
              ...
              >
                ...
                />
                    ...
                    <p>Precision Tracking</p></div>
                </div>

                <button
                  className="shop-now rounded-lg px-4 py-2 text-white cursor-pointer"
                  disabled
                >
                  Shop Now
                </button>
